#
#  Be sure to run `pod spec lint TFY_ProgressHUD.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "tianfengyou"
  # spec.authors            = { "tianfengyou" => "420144542@qq.com" }
  # spec.social_media_url   = "https://twitter.com/tianfengyou"
  ...
  spec.frameworks = "UIKit", "Foundation","AvailabilityMacros","QuartzCore"
